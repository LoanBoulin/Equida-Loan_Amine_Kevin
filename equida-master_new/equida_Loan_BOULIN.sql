...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 27 sep. 2021 à 12:01
...
CREATE TABLE IF NOT EXISTS `acheteur` (
  ...
  `CLI_FORMATION` varchar(200) NOT NULL,
  PRIMARY KEY (`CLI_ID`)
...
(23, 4, 'Starlight', 'F', '53 525 354 I', '16-04-2015', 'starlight.jpg', 321, 742),
(321, 1, 'Jack', 'M', '89 432 642 A', '13-07-2012', NULL, NULL, NULL),
(742, 6, 'Dior', 'F', '54 325 346 G', '20-02-2015', 'dior.jpg', NULL, NULL),
(865, 3, 'Mambo', 'M', '65 352 604 F', '15-09-2016', NULL, NULL, NULL),
...
DROP TABLE IF EXISTS `com_rol`;
CREATE TABLE IF NOT EXISTS `com_rol` (
  `COM_ID` int(2) NOT NULL,
  `ROL_CODE` int(2) NOT NULL,
  PRIMARY KEY (`COM_ID`,`ROL_CODE`),
  KEY `I_FK_COM_ROL_COMPTE` (`COM_ID`),
  KEY `I_FK_COM_ROL_ROLE` (`ROL_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `lot` MODIFY `LOT_ID` INT AUTO_INCREMENT UNIQUE FIRST;
...
CREATE TABLE IF NOT EXISTS `permissions` (
  `PER_CODE` int(2) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `rol_per` (
  `ROL_CODE` int(2) NOT NULL,
  `PER_CODE` int(2) NOT NULL,
  PRIMARY KEY (`ROL_CODE`,`PER_CODE`),
  KEY `I_FK_ROL_PER_ROLE` (`ROL_CODE`),
  KEY `I_FK_ROL_PER_PERMISSIONS` (`PER_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'Yearling', 'Yearling est un anglicisme désignant un cheval pur-sang anglais, descendant du pur sang arabe.'),
