...
public class ServletCourriel extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(url.equals("/equida/ServletCourriel/listerLesCourrielsByVente"))
        {  
            String venId = (String)request.getParameter("venId");
            
            ArrayList<Courriel> lesCourriels = CourrielDAO.getLesCourrielsByVenteId(connection, venId);
            request.setAttribute("pLesCourriels", lesCourriels);
            getServletContext().getRequestDispatcher("/vues/courriel/listerLesCourrielsByVente.jsp").forward(request, response);
